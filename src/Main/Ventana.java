...
public class Ventana extends JFrame{
	...
	public Ventana() {
        ...
        Icon icono1 = new ImageIcon(img1.getImage().getScaledInstance(imagen1.getWidth(), imagen1.getHeight(), Image.SCALE_DEFAULT));
        ...
        Icon icono2 = new ImageIcon(img2.getImage().getScaledInstance(imagen2.getWidth(), imagen2.getHeight(), Image.SCALE_DEFAULT));
        ...
        icono1 = new ImageIcon(img1.getImage().getScaledInstance(imagen1.getWidth(), imagen1.getHeight(), Image.SCALE_DEFAULT));
        imagen1.setIcon(icono1);
        panel1.add(imagen1);
        ...
        icono2 = new ImageIcon(img2.getImage().getScaledInstance(imagen2.getWidth(), imagen2.getHeight(), Image.SCALE_DEFAULT));
        imagen2.setIcon(icono2);
        panel2.add(imagen2);
